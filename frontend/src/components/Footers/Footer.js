        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap text-center lg:text-left">
            <div className="container mx-auto px-4 flex flex-col items-center justify-center text-center">
              <h4 className="text-3xl font-semibold flex">Find more about me here:</h4>
              <div className="mt-6 lg:mb-0 mb-6 flex space-x-4">
                ...
                <a
                  href="https://www.instagram.com/steven.li6/" 
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ color: '#E4405F' }}
                  className="bg-white text-blueGray-800 shadow-lg font-normal h-10 w-10 flex items-center justify-center rounded-full outline-none focus:outline-none mr-2"
                ...
                <a
                  href="https://www.linkedin.com/in/stevenli34462a243" 
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-white text-blueGray-800 shadow-lg font-normal h-10 w-10 flex items-center justify-center rounded-full outline-none focus:outline-none mr-2"
                  style={{ color: '#0077b5' }}
          ...
          <div className="flex flex-wrap items-center md:justify-between justify-center">
            <div className="w-full md:w-4/12 px-4 mx-auto text-center">
              <div className="text-sm text-blueGray-500 font-semibold py-1">
                Made with love thanks to © {new Date().getFullYear()} Notus React{" "}
